...
from dump.nec_onenand_fast_v2 import NecOnenandFast_v2
from dump.nec_gpmc import NecGpmc
from dump.nec_mlc_check import NecMlcCheck
from dump.nec_nor_probe import NecNorProbe
...
DEVICES = [
    ...
    }, secret="d553e21fa631602d5fa0756a09f37424d7cb245d", payload_base=0x80000000, patch=0x80268980,
       usb_command=0x802c4580, usb_data=0x802e560a, usb_datasz=0x802e5604, usb_respfunc=0x80266228,
       onenand_addr=0x08000000),
    ...
    Device("n-03d", 0x0409, 0x02dc, {
        "onenand_id": NecOnenandId(),
        "dump_nand": NecOnenandFast(size=MB(1024)),
    }, secret="d405cf1d23aba71063a902101c7895cb0b3fef77", payload_base=0x80000000, patch=0x80b888c4,
    ...
    Device("n-01e", 0x0409, 0x0418, {
        "onenand_id": NecOnenandId(),
        "dump_nand": NecOnenandFast(size=MB(1024)),
    }, secret="c8d7bd5b4c84c1ccebe7d744eded0af3b6bcbe0b", payload_base=0x80000000, patch=0x80b8883c,
    ...
    Device("f-03a", 0x04c5, 0x1166, {
        "onenand_id": ShSrecExploitOnenandId(),
        "dump_nand": ShSrecExploitOnenandDumper(size=MB(512), has_ddp=True),
